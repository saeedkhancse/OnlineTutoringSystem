    ...
    <div id="content">
        ...
        if (isset($_POST['email']) && isset($_POST['pass'])) {
            ...
            if ( !empty($email) && !empty($password)) {
                            ...
                            $rs = mysql_query("select * from admin_info where  email='$email' and pass='$password'");
                        ...
                        echo '<br><h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp successfully logged in  please go to your <a href="admin.php">admin account</a></h2>';
